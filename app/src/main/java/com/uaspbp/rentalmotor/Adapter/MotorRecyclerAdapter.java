...
import com.uaspbp.rentalmotor.Fragment.DetailMotorFragment;
import com.uaspbp.rentalmotor.R;

import java.util.List;
import java.util.stream.Collectors;

public class MotorRecyclerAdapter extends RecyclerView.Adapter <MotorRecyclerAdapter.MotorViewHolder> implements Filterable {

    private List<MotorDao> dataList;
    private List<MotorDao> filteredDataList;
    private Context context;

    public MotorRecyclerAdapter(List<MotorDao> dataList, Context context) {
