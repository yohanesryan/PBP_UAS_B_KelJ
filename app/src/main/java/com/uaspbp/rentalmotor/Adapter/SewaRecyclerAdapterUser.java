...
import com.uaspbp.rentalmotor.Fragment.DetailMotorFragmentSewa;
import com.uaspbp.rentalmotor.R;

import java.util.List;
import java.util.stream.Collectors;

public class SewaRecyclerAdapterUser extends RecyclerView.Adapter <com.uaspbp.rentalmotor.Adapter.SewaRecyclerAdapterUser.MotorViewHolder> implements Filterable {

    private List<MotorDao> dataList;
    private List<MotorDao> filteredDataList;
    private Context context;

    public SewaRecyclerAdapterUser(List<MotorDao> dataList, Context context) {
    ...
    @NonNull
    @Override
    public com.uaspbp.rentalmotor.Adapter.SewaRecyclerAdapterUser.MotorViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.recycler_adapter_motor_user, parent, false);
        return new com.uaspbp.rentalmotor.Adapter.SewaRecyclerAdapterUser.MotorViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull com.uaspbp.rentalmotor.Adapter.SewaRecyclerAdapterUser.MotorViewHolder holder, int position) {
        ...
        holder.mParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DetailMotorFragmentSewa dialog = new DetailMotorFragmentSewa();
